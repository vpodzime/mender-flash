 ...
 *       size_t. However, I/O syscalls that manipulate data (read, write,...)
 *       use size_t for their arguments.
 */
#define MIN_SIZE(X, Y) ((size_t) MIN((off_t) SIZE_MAX, MIN((off_t) X, (off_t) Y)))
